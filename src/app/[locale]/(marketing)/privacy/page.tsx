...
const privacyContent = {
  en: {
    ...
    intro:
      "We take data protection seriously. This policy explains how SeventeenLabs collects, stores, and processes personal data when you visit our website or work with our team.",
    sections: [
      {
  ...
  de: {
    ...
    intro:
      "Der Schutz Ihrer Daten hat für uns höchste Priorität. Diese Erklärung beschreibt, wie SeventeenLabs personenbezogene Daten sammelt, speichert und verarbeitet, wenn Sie unsere Website besuchen oder mit unserem Team zusammenarbeiten.",
    sections: [
      {
...
export async function generateMetadata({
  ...
  const pageTitle = isGerman
    ? "Datenschutz | SeventeenLabs"
    : "Privacy Policy | SeventeenLabs";
