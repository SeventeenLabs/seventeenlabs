...
const termsContent = {
  en: {
    ...
    intro: 'These Terms govern your access to SeventeenLabs websites, applications, and professional services. By working with us, you agree to the responsibilities and commitments described below.',
    sections: [
      {
  ...
  de: {
    ...
    intro: 'Diese Bedingungen regeln den Zugriff auf die Websites, Anwendungen und Beratungsleistungen von SeventeenLabs. Durch die Zusammenarbeit mit uns akzeptieren Sie die folgenden Pflichten und Vereinbarungen.',
    sections: [
      {
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const pageTitle = isGerman ? 'AGB | SeventeenLabs' : 'Terms of Service | SeventeenLabs';
