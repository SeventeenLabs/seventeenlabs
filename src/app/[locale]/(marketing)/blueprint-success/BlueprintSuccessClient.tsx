          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm text-left mb-8">
              ...
              <div className="space-y-6">
                {["Check your email", "Schedule your kickoff call", "We analyze your business", "Receive your blueprint (5-7 days)"].map((title, index) => (
...
export default function BlueprintSuccessClient() {
  return (
    <Suspense
      fallback={
