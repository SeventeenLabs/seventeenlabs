    ...
    (
      <div
        style={{
          ...
          background: 'linear-gradient(135deg, #0a1a14, #0f2820, #1a4d3a)',
          padding: '60px 80px',
        }}
      >
        {/* Logo */}
        ...
        <div style={{ display: 'flex', gap: '60px' }}>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ fontSize: '36px', color: 'white' }}>70%</div>
            <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>Time Saved</div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ fontSize: '36px', color: 'white' }}>3x</div>
            <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>More Clients</div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ fontSize: '36px', color: 'white' }}>24/7</div>
            <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>Automation</div>
          </div>
        </div>
      </div>
    ),
