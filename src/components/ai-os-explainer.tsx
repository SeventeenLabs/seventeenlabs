...
export default function AiOsExplainer() {
  ...
  return (
    <section className="relative border-t border-white/10 bg-black py-20 sm:py-24 lg:py-32">
      ...
      <div className="relative mx-auto w-full max-w-[94rem] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-2xl font-medium tracking-tight text-white sm:text-4xl lg:text-5xl" style={{ fontFamily: "var(--font-display)" }}>
            {isGerman
