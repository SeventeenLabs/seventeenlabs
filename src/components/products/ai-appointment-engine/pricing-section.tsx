...
export default function PricingSection() {
  ...
  const setupFeatures = translations.reportFlowEngine?.pricing?.setup?.features || [];
  const monthlyFeatures = translations.reportFlowEngine?.pricing?.monthly?.features || [];
  const valueItems = translations.reportFlowEngine?.pricing?.value?.items || [];
  return (
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20">
        ...
        >
          ...
          <span className="text-xs sm:text-sm font-light text-white/60 tracking-wider uppercase mb-4 sm:mb-6 block">
            {t('reportFlowEngine.pricing.eyebrow')}
          </span>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-light text-white tracking-tight mb-8 sm:mb-12 leading-tight">
            <span dangerouslySetInnerHTML={{ __html: t('reportFlowEngine.pricing.title') }} />
          </h2>
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="pb-6 sm:pb-8 border-b border-white/10">
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-3 sm:mb-4">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-light text-white mb-2 sm:mb-0">{t('reportFlowEngine.pricing.setup.title')}</h3>
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-light text-blue-400">{t('reportFlowEngine.pricing.setup.price')}</div>
                </div>
              ...
              <div className="pb-6 sm:pb-8 border-b border-white/10">
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-3 sm:mb-4">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-light text-white mb-2 sm:mb-0">{t('reportFlowEngine.pricing.monthly.title')}</h3>
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-light text-blue-400">{t('reportFlowEngine.pricing.monthly.price')}<span className="text-base sm:text-xl text-white/60">{t('reportFlowEngine.pricing.monthly.priceUnit')}</span></div>
                </div>
                <div className="space-y-1 sm:space-y-2 text-sm sm:text-base text-white/60 font-light">
          ...
          {/* Value */}
          <div className="mb-16 sm:mb-20">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-light text-white mb-6 sm:mb-8">{t('reportFlowEngine.pricing.value.title')}</h3>
          ...
          <div className="mb-12 pb-8 border-b border-green-500/20">
            <h3 className="text-2xl font-light text-white mb-4">{t('reportFlowEngine.guarantee.timeGuarantee.title')}</h3>
          ...
          {/* CTA */}
          <div>
            <h3 className="text-2xl font-light text-white mb-4">{t('reportFlowEngine.pricing.cta.title')}</h3>
            <p className="text-white/70 font-light mb-8">
              {t('reportFlowEngine.pricing.cta.description')}
            </p>
            <a href="https://calendly.com/chris-seventeenlabs/30min" target="_blank" rel="noopener noreferrer" className="group px-10 py-5 text-base font-medium text-black bg-blue-500 rounded-lg hover:bg-blue-400 transition-all duration-300 flex items-center gap-3 inline-flex">
              {t('reportFlowEngine.pricing.cta.button')}
